...
OBJ=boot.o extract_float_sysv32.o port.o paging.o pit.o serial.o load_gdt.o load_idt.o gdt.o idt.o isr.o memory.o string.o vga.o kernel.o my_printf.o
BIN=myos.bin
ISO=myos.iso
...
build:
	...
	$(CC) $(INC) $(C_FLAGS) $(SRC)/my_printf.c -o my_printf.o
